...
const s = StyleSheet.create({
  ...
  bizName: { fontSize: 17, fontWeight: "700", textAlign: "center" },
  bizCategory: { fontSize: 11, fontWeight: "600" },
  ratingRow: { flexDirection: "row", alignItems: "center", gap: 2, marginTop: 2 },
  ratingText: { fontSize: 11, marginLeft: 4 },
  starFilled: { fontSize: 15, color: "#FFD200", lineHeight: 20 },
  starEmpty: { fontSize: 15, color: "rgba(255,255,255,0.22)", lineHeight: 20 },
  ratingValue: { fontSize: 13, fontWeight: "700", color: "#FFD200", marginLeft: 6 },
  ratingCount: { fontSize: 11, fontWeight: "400" },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  metaText: { fontSize: 11 },
  description: { fontSize: 13, textAlign: "center", lineHeight: 20, marginTop: 4 },
  ...
  catChipText: { fontSize: 11, fontWeight: "600", color: ACCENT },
  serviceInfo: { flex: 1, gap: 4 },
  serviceName: { fontSize: 13, fontWeight: "600" },
  serviceDesc: { fontSize: 11, lineHeight: 17 },
  ...
  bookBtnText: { color: "#FFFFFF", fontSize: 11, fontWeight: "700" },
  ...
  staffRole: { fontSize: 11, fontWeight: "600" },
  staffBio: { fontSize: 11, lineHeight: 17 },
  hoursRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: DIVIDER },
  hoursDay: { fontSize: 13, fontWeight: "600", color: TEXT_PRIMARY },
  ...
  locationHoursName: { fontSize: 13, fontWeight: "700", color: TEXT_PRIMARY },
  ...
  reviewComment: { fontSize: 11, lineHeight: 18 },
  ...
  writeReviewBtnText: { color: "#fff", fontSize: 13, fontWeight: "700" },
  reviewModal: { borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40,
    width: '100%',
    maxWidth: 560,
    alignSelf: 'center' as const },
  reviewModalTitle: { fontSize: 15, fontWeight: "700" },
  ...
  stickyBookBtnText: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
  photoCaptionBar: { position: "absolute", bottom: 0, left: 0, right: 0, paddingHorizontal: 16, paddingVertical: 8 },
  photoCaptionText: { color: "#FFFFFF", fontSize: 11, fontWeight: "500" },
  ...
  lightboxCaption: { textAlign: "center", fontSize: 13, marginTop: 12, paddingHorizontal: 24 },
});
