          ...
          <StoreProvider>
            ...
            <Stack screenOptions={{ headerShown: false }}>
              ...
              <Stack.Screen name="(client-tabs)" options={{ presentation: "fullScreenModal",
                ...
                contentStyle: { flex: 1 } }} />
              <Stack.Screen name="client-business-detail" options={{ presentation: "fullScreenModal", contentStyle: { backgroundColor: "#0D2318" }, gestureEnabled: true, headerShown: false }} />
              <Stack.Screen name="client-booking-wizard" options={{ presentation: "modal", headerShown: false, contentStyle: { backgroundColor: "#0D2318" }, gestureEnabled: true }} />
              <Stack.Screen name="client-buy-gift" options={{ presentation: "modal", headerShown: false, contentStyle: { backgroundColor: "#0D2318" }, gestureEnabled: true }} />
